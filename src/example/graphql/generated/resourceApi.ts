...
export const UserFieldsFragmentDoc = `
  ...
  email
    ...
    `;
export const UpsertAddressDocument = `
  ...
  insertAddress(
    ...
    `;
export const useUpsertAddressMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<UpsertAddressMutation, TError, UpsertAddressMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<UpsertAddressMutation, TError, UpsertAddressMutationVariables, TContext>(
      ['upsertAddress'],
      (variables?: UpsertAddressMutationVariables) => fetcher<UpsertAddressMutation, UpsertAddressMutationVariables>(client, UpsertAddressDocument, variables, headers)(),
      options
    );
export const AddressByUserIdDocument = `
...
export const useAddressByUserIdQuery = <
      TData = AddressByUserIdQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: AddressByUserIdQueryVariables,
      options?: UseQueryOptions<AddressByUserIdQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<AddressByUserIdQuery, TError, TData>(
      ['addressByUserId', variables],
      fetcher<AddressByUserIdQuery, AddressByUserIdQueryVariables>(client, AddressByUserIdDocument, variables, headers),
      options
    );
...
export const useUpsertUsersMutation = <
    ...
    useMutation<UpsertUsersMutation, TError, UpsertUsersMutationVariables, TContext>(
      ['upsertUsers'],
      (variables?: UpsertUsersMutationVariables) => fetcher<UpsertUsersMutation, UpsertUsersMutationVariables>(client, UpsertUsersDocument, variables, headers)(),
      options
    );
