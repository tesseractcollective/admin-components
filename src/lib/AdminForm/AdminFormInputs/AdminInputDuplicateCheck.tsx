...
export type AdminInputTextCheckProps = InputTextProps &
  AdminInputBaseProps &
  InputDuplicateCheckProps;

export const AdminInputDuplicateCheck: React.FC<AdminInputTextCheckProps> = (
  props
) => {
  validateProps(props);
  const {
