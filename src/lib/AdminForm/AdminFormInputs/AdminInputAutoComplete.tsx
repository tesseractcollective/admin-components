...
export type AdminInputAutoCompleteProps = AutoCompleteProps &
  AdminInputBaseProps &
  InputRelationProps;
type OptionProps = { value: any; label: string; pk?: string };

export const AdminInputAutoComplete: React.FC<AdminInputAutoCompleteProps> = (
  props
) => {
  validateProps(props);
  const {
