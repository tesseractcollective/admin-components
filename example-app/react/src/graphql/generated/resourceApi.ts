...
export const UserFieldsFragmentDoc = `
  ...
  id
    ...
    `;
export const AddressByIdDocument = `
...
export const useAddressByIdQuery = <
      TData = AddressByIdQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: AddressByIdQueryVariables,
      options?: UseQueryOptions<AddressByIdQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<AddressByIdQuery, TError, TData>(
      ['addressById', variables],
      fetcher<AddressByIdQuery, AddressByIdQueryVariables>(client, AddressByIdDocument, variables, headers),
      options
    );
